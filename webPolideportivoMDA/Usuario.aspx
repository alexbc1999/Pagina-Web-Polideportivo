<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Usuario.aspx.cs" Inherits="webPolideportivoMDA.Usuario" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class ="container">
        ...
        <a>&nbsp;Usuario: <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label></a><br />
...
&nbsp;&nbsp;&nbsp;&nbsp; <br />
            ...
            <a>Puntuación: </a><asp:TextBox ID="puntuacion" width ="80px" Height="20px" placeholder="Puntuacion: " runat="server" Enabled="False"></asp:TextBox>
            <br />
            <br />
